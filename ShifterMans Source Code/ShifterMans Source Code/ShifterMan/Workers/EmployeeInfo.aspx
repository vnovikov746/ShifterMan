<%@ Page Title="Employee Information Page" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true"
    CodeFile="EmployeeInfo.aspx.cs" Inherits="Workers_EmployeeInfo" %>
                     ...
                     <tr>
                        ...
                        <td>
                            ...
                            <asp:RegularExpressionValidator ID="RegularExpressionValidator1" runat="server" 
                                ControlToValidate="Password" Display="Dynamic" ErrorMessage="Password must contain EXACLY 6 letters/numbers" 
                                ValidationExpression="([0-z]{6})"></asp:RegularExpressionValidator>
                        </td>
                    </tr>
                    <tr>
