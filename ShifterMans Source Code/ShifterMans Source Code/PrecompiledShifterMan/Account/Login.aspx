...
<asp:Content ID="BodyContent" runat="server" ContentPlaceHolderID="MainContent">
    ...
    <p>
        ...
        <asp:HyperLink ID="RegisterHyperLink" runat="server" EnableViewState="False" 
            NavigateUrl="~/Account/Register.aspx" ToolTip="Press to register new organization.">Register</asp:HyperLink> if you don't have an account.
    </p>
            <table class="style1">
                <tr>
                    <td>
                <table class="style1">
                    <tr>
                        ...
                        <td class="style1">
                            <asp:DropDownList ID="OrgNameList" runat="server" DataSourceID="OrganizationName" DataTextField="Organization_Name" DataValueField="Organization_Name" ToolTip="Choose organization you working in.">
                            </asp:DropDownList>
                    ...
                    <tr>
                        ...
                        <td>
                            <asp:TextBox ID="TxtID1" runat="server" ToolTip="Enter your ID number. (must be 9 numbers long)"></asp:TextBox>
